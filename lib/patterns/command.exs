defmodule Patterns.Command.Commands.CopyFile do
...
defmodule Patterns.Command.Commands.CreateFile do
...
defmodule Patterns.Command.Commands.DeleteFile do
  def execute(path) do
    IO.puts("mv #{path} /path/to/trash")
  end
...
defmodule Patterns.Command.Runner do
  use GenServer
  def start_link do
    state = %{done: [], undone: []}
...
defmodule Patterns.Command.Run do
  alias Patterns.Command.{Runner, Commands}

  Runner.start_link

  commands = [
    {Commands.CreateFile, ["file1.txt", "hello world"]},
    {Commands.CopyFile, ["file1.txt", "file2.txt"]},
    {Commands.DeleteFile, "file1.txt"}
  ]
